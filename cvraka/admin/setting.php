                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama_website" placeholder="Masukkan Nama Website" required value="<?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" ? $rowEdt['nama_website'] : (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['nama_website'] : '') ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="alamat_website" placeholder="Masukkan Alamat Website" required value="<?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" ? $rowEdt['alamat_website'] : (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['alamat_website'] : '') ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" name="email" placeholder="Masukkan Email Anda" required value="<?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" ? $rowEdt['email'] : (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['email'] : '') ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="tlpn" placeholder="Masukkan Nomor Telepon" required value="<?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" ? $rowEdt['tlpn'] : (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['tlpn'] : '') ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-2">
