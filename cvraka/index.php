    			...
    			<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Name:</span> <span>Raka Anugerah Pratama</span></li>
		            	<li class="d-flex"><span>Date of birth:</span> <span>January 14, 2004</span></li>
		            	<li class="d-flex"><span>Address:</span> <span>Kebon Kacang 41 Jakarta Pusat</span></li>
		            	<li class="d-flex"><span>Zip code:</span> <span>1000</span></li>
		            	<li class="d-flex"><span>Email:</span> <span>rakaanugerah235@gmail.com</span></li>
		            	<li class="d-flex"><span>Phone: </span> <span>+62-895-3475-7050-4</span></li>
		            </ul>
		          </div>
		        </div>
