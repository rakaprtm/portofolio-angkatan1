...
if (isset($_POST['simpan'])) {
    ...
    if ($foto['error'] == 0) {
        ...
        $insert = mysqli_query($conn, "INSERT INTO blog (id_kategori, judul, isi, tags ,penulis,  foto, status) VALUES ('$kategori', '$judul', '$isi', '$tags', '$penulis',  '$fileName','$status')");
        if ($insert) {
...
if (isset($_GET['edit']) && isset($_POST['edit'])) {
    ...
    $update = mysqli_query($conn, "UPDATE blog SET id_kategori='$kategori', judul='$judul', isi='$isi', tags='$tags' ,penulis='$penulis', created='$created' ,foto='$filename', status='$status' WHERE id = $idEdt");
...
if (isset($_GET['edit'])) {
    ...
    if ($_FILES['foto']['error'] == 0) {
        ...
        $update = mysqli_query($conn, "UPDATE blog SET 
            id_kategori='$kategori', judul='$judul', isi='$isi', tags='$tags' ,penulis='$penulis',foto='$filename', status='$status'
            WHERE id = $idEdt");
    } else {
        $update = mysqli_query($conn, "UPDATE blog SET 
            id_kategori='$kategori', judul='$judul', isi='$isi', tags='$tags' ,penulis='$penulis', foto='$filename', status='$status'' WHERE id = $idEdt");
    }
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="judul" placeholder="Masukkan judul" required value="<?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" || isset($_GET['sidebar']) && $_GET['sidebar'] == "setting" ? $rowEdt['judul'] : (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['judul'] : '') ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-2">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="tags" placeholder="Masukkan penulis" required value="<?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" || isset($_GET['sidebar']) && $_GET['sidebar'] == "setting" ? $rowEdt['tags'] : (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['tags'] : '') ?>">
                                    </div>
                                </div>
