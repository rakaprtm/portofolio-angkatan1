...
// Tambahkan koneksi database di sini
...
if (isset($_POST['simpan'])) {
    ...
    if (mysqli_num_rows($querySetting) > 0) {
        ...
        $update = mysqli_query($conn, "UPDATE setting SET nama_website='$nama_website', alamat_website='$alamat_website', nama_lengkap='$nama_lengkap',tanggal_lahir='$tanggal_lahir', kode_pos='$kode_pos', email='$email', tlpn='$tlpn', alamat='$alamat', $fillQupdate WHERE id = 1");
        ...
        if ($logo['error'] == 0) {
            ...
            $insert = mysqli_query($conn, "INSERT INTO setting (nama_website, alamat_website, nama_lengkap, tanggal_lahir, kode_pos, email, tlpn, alamat, logo) VALUES('$nama_website', '$alamat_website', '$nama_lengkap', '$tanggal_lahir', '$kode_pos', '$email', '$tlpn', '$alamat', '$fileName')");
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="alamat_website" placeholder="Masukkan Alamat Website" required value="<?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" || isset($_GET['sidebar']) && $_GET['sidebar'] == "setting" ? $rowEdt['alamat_website'] : (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['nama_website'] : '') ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-2">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="kode_pos" placeholder="Masukkan Alamat Website" required value="<?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" || isset($_GET['sidebar']) && $_GET['sidebar'] == "setting" ? $rowEdt['kode_pos'] : (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['kode_pos'] : '') ?>">
                                    </div>
                                </div>
                                </div>
                                <div class="row mb-3">
